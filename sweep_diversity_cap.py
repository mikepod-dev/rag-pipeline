...
def run_retrieval_sweep(cap_values=[1, 2, 3, 4, 5, 999]):
    ...
    print(f"Sweeping diversity cap over {len(cases_with_source)} eval cases with a known expected source\n")
    ...
    for cap in cap_values:
        ...
        print(f"max_per_source={cap}: retrieval accuracy = {correct}/{len(cases_with_source)} ({accuracy:.1%})")
